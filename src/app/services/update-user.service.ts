...
//   handleUpdateUser(url: string, updatedUserData: any) {
...
//     this.dataService.putData(url, updatedUserObject).subscribe(
//       (res: any) => {
//         // console.log("Response:", res);
//         if (res.error) {
//           this.popUpService.popup("error", res.error.error || "Update failed try again", 5000);
//         } else if (res.message) {
//           // console.log("res:", res);
//           this.popUpService.popup("success", res.message || "Data updated", 10000);
//         }
//       },
//       (error) => {
//         console.error("Update API Error:", error);
//         this.popUpService.popup("error", error?.error?.error || "Server error try again latter", 5000);
//       }
//     );
//   }

//   updateUser(icon: any, text: string, user: any) {
//     Swal.fire({
//       title: "<span class='text-purple-700'>Edit User Data</span>",
//       html: `
//       <form id="swal-update-form">
...
//         if (!email) {
//           Swal.showValidationMessage('Please fill in email field');
//           return false; // ✅ explicitly return something
//         }
...
//         this.handleUpdateUser(`users/${user.userId}`, updatedUserData);
